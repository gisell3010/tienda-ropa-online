...
public class CompraServiceImp implements CompraService {
    ...
    public CompraResponseDTO registrarCompra(CompraRequestDTO request) {
        ...
        if (request == null) {
            return new CompraResponseDTO(false, "Debe enviar los datos de la compra.", null);
        }
        ...
        for (CompraDetalleDTO detalle : request.getDetalles()) {
            if (detalle == null) {
                return new CompraResponseDTO(false, "El detalle de la compra no puede estar vacío.", null);
            }
